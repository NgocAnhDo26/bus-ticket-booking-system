        ...
        <div className="flex h-[300px] divide-x">
          <ScrollArea className="h-full w-24 p-2">
            <div className="flex flex-col gap-1 p-1">
              <div className="text-sm font-medium text-muted-foreground px-2 py-1 mb-1 text-center">Giờ</div>
              {hours.map((hour) => (
                <Button
                  key={hour}
          ...
          <ScrollArea className="h-full w-24 p-2">
            <div className="flex flex-col gap-1 p-1">
            <div className="text-sm font-medium text-muted-foreground px-2 py-1 mb-1 text-center">Phút</div>
              {minutes.map((minute) => (
                <Button
                  key={minute}
