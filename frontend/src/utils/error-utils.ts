export const getFriendlyErrorMessage = (error: unknown): string => {
    ...
    if (lowerMsg.includes('invalid activation token') || lowerMsg.includes('activation token expired')) {
    ...
    if (lowerMsg.includes('old password is incorrect') || (lowerMsg.includes('password') && lowerMsg.includes('incorrect'))) {
    ...
    if (lowerMsg.includes('google sign-in failed') || lowerMsg.includes('invalid google credential')) {
