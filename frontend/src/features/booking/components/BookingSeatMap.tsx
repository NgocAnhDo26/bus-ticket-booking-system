...
export const BookingSeatMap = ({ busLayoutId, alreadyBookedSeats = [], selectedSeats: propSelectedSeats, onSeatClick: propOnSeatClick }: BookingSeatMapProps) => {
  // const { user } = useAuthStore(); // Unused variable removed

  const { seatStatusMap, toggleSeat, selectedSeats: storeSelectedSeats } = useBookingStore(
    useShallow((state) => ({
