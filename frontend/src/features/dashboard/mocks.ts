...
export const getMockDashboard = (): DashboardResponse => ({
  summary: [
    { label: 'Total Bookings', value: '1,248', trend: '+12% vs last week', trendDirection: 'up' },
    { label: 'Seat Occupancy', value: '84%', trend: '+4% vs avg', trendDirection: 'up' },
    { label: 'Revenue', value: '₫1.2B', trend: '-3% vs last week', trendDirection: 'down' },
  ],
  activity: [
    {
      id: '1',
