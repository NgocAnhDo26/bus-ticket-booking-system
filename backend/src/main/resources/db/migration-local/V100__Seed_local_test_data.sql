...
--
-- NOTE: This is intentionally versioned far beyond the main migration sequence to avoid
-- duplicate version conflicts if the main migrations also include a V6 placeholder.
...
-- Booking and tickets
INSERT INTO bookings (id, code, trip_id, user_id, total_price, status, passenger_name, passenger_phone, created_at, updated_at)
VALUES
    ('a111b222-0001-4c3d-9000-000000000001', 'A111B222', 'f7a8b9c0-0001-493a-9000-000000000001', '5d9f7d8c-0001-4e0a-91a1-000000000002', 850000, 'CONFIRMED', 'Nguyen Van A', '+84991231231', now(), now())
ON CONFLICT (id) DO NOTHING;
